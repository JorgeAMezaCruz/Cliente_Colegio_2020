...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div class="container body-content">
			...
			<h4 style="text-align: center">Consulta de docentes por sección</h4>

			<div class="col-md-8">
				<form>
					<div class="form-group">
						<label for="exampleInputEmail1">Seccion</label> <select
							id="seccion" name="seccion.nomSeccion" class="form-control"
							required>
							<option value="">[Seleccione]</option>
							<c:forEach items="${requestScope.dataSecciones}" var="s">
								<option value="${s.nomSeccion}">${s.nomSeccion}</option>
							</c:forEach>
						</select>
						<div>
				...
				<div class="row">
					<div class="col-5">
						<input class="form-control" id="seccion" name="seccion.nomSeccion"
							placeholder="Seccion" />
					</div>
					<div class="col-2">
						<button type="button" class="btn btn-primary">Consultar</button>
															...
															.each(
																	...
																	function(
																		...
																		$(
																				...
																				.append(
																						"<tr><td>"
																								+ item.codDocenteCurso
																								+ "</td><td>"
																								+ item.docente.nomDocente
																								+ ' '
																								+ ' '
																								+ item.docente.apePaternoDocente
																								+ ' '
																								+ item.docente.apeMaternoDocente
