...
<body id="page-top">
		...
		<div class="container body-content">
			...
			<div class="card shadow-lg">
				<div class="card-header">
					<h3 class="m-0 font-weight-bold text-dark">Listado de Cursos</h3>
					<br>

					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target="#modalProgramador">Agregar Curso</button>
								...
								<tr>
									...
									<td>
										<button type='button' data-toggle='modal'
											onclick="editar('${c.idCurso}','${c.nomCurso}');"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="frmProgramador" action="saveCurso" method="post"
								data-toggle="validator" role="form">
								<div hidden class="form-group">
									<label class="col-lg-3 control-label" for="id_curso">Codigo
										de Curso</label>
									<div class="col-lg-5">
										<input class="form-control" id="id_curso" readonly="readonly"
											name="id_curso" type="text" value="0" />
									</div>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Nombre de Curso</label> <input
										type="text" class="form-control" name="nombre_curso"
										id="nombre_curso" autocomplete="off">
								</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="id_form_actualiza" accept-charset="UTF-8"
								action="saveCurso" class="form-horizontal" method="post">
								<div class="form-group">
									<label for="id_curso">Codigo de Curso</label> <input
										class="form-control" id="id_curso" readonly="readonly"
										name="id_curso" type="text" maxlength="8" />
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Nombre de Curso</label> <input
										type="text" class="form-control" name="nombre_curso"
										id="act_nombre_curso" autocomplete="off">
								</div>
	...
	<script type="text/javascript">
		function editar(id, nom) {
			$('input[id=id_curso]').val(id);
			$('input[id=act_nombre_curso]').val(nom);
												...
												fields : {
													nombre_curso : {
														validators : {
															...
															regexp : {
																regexp : /^[a-zA-Z\s\ñ\Ñ\á\é]{1,30}$/,
																message : 'Campo seccion solo hasta max 30 letras'
															}
														}
													},
